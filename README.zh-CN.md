...
**数据核验日期：2026-09-02。** 截止时间、参赛资格和授权条款可能临时调整，提交前请再次阅读官方规则。
...
- [`data/candidates.json`](data/candidates.json) 中有 **13 条待核验候选**。候选在官方页面、规则和截止时间通过核验前，不会进入网站公开清单、RSS 或日历。
...
|---|---|---|---|---|---|
| 🟢 报名中 | 2026-09-15<br><sub>官网未注明</sub> | 🎬 视频 | **[Austin AI Film Festival 2026](https://filmfreeway.com/AustinAIFilmFestival)**<br><sub>全球 14 岁及以上创作者；多数 AI 竞赛单元要求主要视觉内容由 AI 辅助工具生成 · [规则](https://filmfreeway.com/AustinAIFilmFestival)</sub> | 美国 / 全球开放（部分受限地区除外） | 奖项与入选展映；具体奖励以官方页为准<br><sub>费用：多数单元 US$20；学生单元设免费选项</sub> |
| 🟢 报名中 | 2026-09-19<br><sub>UTC 23:59</sub> | 🧩 应用 | **[ARC 白盒估计挑战赛 2026（WhestBench）](https://www.aicrowd.com/challenges/arc-white-box-estimation-challenge-2026)**<br><sub>AIcrowd 注册参赛者或团队；须提交符合官方 starter kit 规范的可执行 Python 估计器，奖金资格以官方规则为准 · [规则](https://www.aicrowd.com/challenges/arc-white-box-estimation-challenge-2026/challenge_rules)</sub> | 线上 / 资格以官方规则为准 | 总奖池 US$150,000+；其中第二阶段奖池 US$100,000<br><sub>费用：官网未列报名费</sub> |
...
| 🟢 报名中 | 2026-11-11<br><sub>美国东部时间 17:00；须于 10 月 28 日 17:00 前注册</sub> | 🧩 应用 | **[NASA TechLeap Prize：Orbital Clarity Challenge](https://occ.nasatechleap.org/)**<br><sub>个人须为年满 18 岁的美国公民或永久居民；机构须在美国注册并以美国为主要营业地；团队须由合资格人士领队，外籍成员另受官方规则限制 · [规则](https://occ.nasatechleap.org/rules-terms-and-conditions/)</sub> | 美国 / 线上 / 资格受限 | 总奖池 US$2,000,000；最多四名获奖者各可获最高 US$500,000，并有机会免费进行在轨测试<br><sub>费用：官网未列报名费；潜在获奖者须证明具备 US$250,000 责任险或同等财务能力</sub> |
