...
![Contests](https://img.shields.io/badge/active-13-2ea44f) ![Last verified](https://img.shields.io/badge/verified-2026-09-02-0969da) [![License: MIT](https://img.shields.io/badge/license-MIT-yellow.svg)](LICENSE)
...
**Data verified on 2026-09-02.** Deadlines, eligibility, fees, and licensing terms may change without notice. Always read the official rules before submitting.
...
| 🟢 Open | 2026-09-19<br><sub>23:59 UTC</sub> | 🧩 App | **[ARC White-Box Estimation Challenge 2026 (WhestBench)](https://www.aicrowd.com/challenges/arc-white-box-estimation-challenge-2026)**<br><sub>Registered AIcrowd participants or teams must submit an executable Python estimator that follows the official starter-kit contract; prize eligibility is subject to the official rules · [Rules](https://www.aicrowd.com/challenges/arc-white-box-estimation-challenge-2026/challenge_rules)</sub> | Online / Eligibility subject to the official rules | US$150,000+ total across phases, including a US$100,000 Phase 2 prize pool<br><sub>Fee: No entry fee is listed on the official page</sub> |
...
| 🟢 Open | 2026-11-11<br><sub>5:00 PM ET; registration is required by 5:00 PM ET on October 28</sub> | 🧩 App | **[NASA TechLeap Prize: Orbital Clarity Challenge](https://occ.nasatechleap.org/)**<br><sub>Individuals must be U.S. citizens or permanent residents aged 18+; organizations must be incorporated and primarily based in the U.S.; teams need an eligible lead, with foreign members subject to the official restrictions · [Rules](https://occ.nasatechleap.org/rules-terms-and-conditions/)</sub> | United States / Online / Restricted eligibility | US$2,000,000 total; up to four winners may receive up to US$500,000 each plus an opportunity for a no-cost orbital test<br><sub>Fee: No entry fee is listed; potential winners must show US$250,000 in liability coverage or equivalent financial responsibility</sub> |
